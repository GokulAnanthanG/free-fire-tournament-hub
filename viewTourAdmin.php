...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-xl btn-danger all">Delete All</button>
<br><br><br><div class="container"> <div class="col-md-12 data"></div>
</div>
...
alert(d)
 ...
 $.ajax({
     url:"http://localhost/ff/displayTourAdmin.php",
     type:"GET",
     success:function(d){
         $(".data").html(d)
      }
